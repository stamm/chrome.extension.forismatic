...
get_db().transaction(function(tx) {
	tx.executeSql("SELECT * FROM quotes ORDER BY rowid DESC LIMIT 4", [], function(tx, result) {
		for(var i = 0; i < result.rows.length; i++) {
			...
			var social = ' <a target="_blank" title="' + chrome.i18n.getMessage('writeInVkontakte') + '" href="http://vkontakte.ru/share.php?url=' + link + '&title=' + textToSocial + '"><img src="http://vkontakte.ru/images/faviconnew.ico" alt="Vkontakte" /></a>&nbsp;<a target="_blank" title="' + chrome.i18n.getMessage('writeInTwitter') + '" href="http://twitter.com/home?status=' + encodeURIComponent(twitterText) + '"><img src="https://twitter.com/phoenix/favicon.ico" alt="Twitter" /></a>&nbsp;<a target="_blank" title="' + chrome.i18n.getMessage('writeInFacebook') + '" href="http://www.facebook.com/sharer.php?u=' + encodeURIComponent(link) + '&t=' + encodeURIComponent(textToSocial) + '"><img src="http://static.ak.fbcdn.net/rsrc.php/yi/r/q9U99v3_saj.ico" alt="Facebook" /></a>';
			var text = '';
